...
def test_day24_part1_ex01():
    """
    Test method for AOC 2017 Day 24 Part 1 using example input 1.
    """
    input_data = day24.process_input_file("./input/examples/day24_ex01.txt")
